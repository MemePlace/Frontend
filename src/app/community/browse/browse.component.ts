...
export class BrowseComponent implements OnInit {
  ...
  user7 = {un: 'dante888', height: '723', img: 'http://i0.kym-cdn.com/photos/images/original/001/224/694/300'};

  users = [this.user1, this.user2, this.user3, this.user4, this.user5, this.user6, this.user7];
